const questions = [
    ...
    {
        "question": "远程登录日志一般保存在下列（B）类型的日志中。",
        "options": [
            "A.系统日志",
            "B.安全日志",
            "C.应用程序日志",
    ...
    },
    {
        ...
        "answer": "A",
        "hint": "对已删除文件的恢复、重建技术不属于不属于数据分析技术。"
    },
    {
    ...
    },
    {
        ...
        "answer": "A",
        "hint": "静态分析可以检测程序在运行时的行为，这对于获取客服等运行时信息很有帮助。"
    },
    {
    ...
    {
        "question": "涉网新型案件涉案的裸聊案件中受害人在APP上进行裸聊的视频以及手机通讯录等信息会被受害人保存在哪里（B）。",
        "options": [
            "A.该APP内",
            "B.该APP后台服务器中",
            "C.嫌疑人手机内",
        ...
        "answer": "B",
        "hint": "受害人在APP上产生的信息，如视频和通讯录，通常会保存在APP服务器。"
    },
    {
    ...
    {
        "question": "Windows系统服务器安全日志中记录服务器被远程登录成功的事件ID为（C）。",
        "options": [
            "A.4627",
            "B.4625",
            "C.4624",
        ...
        "answer": "C",
        "hint": "事件ID4624表示用户成功登录到服务器，这是安全日志的一部分。"
    },
    {
    ...
    },
    {
        ...
        "options": [
            ...
            "C.select rownum, ename, salary from emp order by salarydescl imit 3",
    ...
    {
        "question": "使用华为手机助手进行数据备份，备份的密码信息存储在以下哪个文件中。（D）",
        "options": [
            "A.datainfo.ini",
            "B.datainfo.dat",
            "C.backupinfo.dat",
        ...
        "answer": "D",
        "hint": "华为手机助手备份的数据，包括密码信息，通常存储在'backupinfo.ini'文件中。"
    },
    {
    ...
    {
        "question": "如果对象将多个JPEG图片的文件的扩展名改为其他名称,通过（C）可以快速找到这些文件。",
        "options": [
            "A.散列值比对(MD5)",
            "B.散列值比对(SHA-1)",
            "C.文件签名分析",
        ...
        "answer": "C",
        "hint": "文件签名分析通过检查文件的内容而不是文件名，可以识别文件类型，即使文件扩展名被更改。JPEG文件通常有特定的签名（如文件的前几个字节），文件签名分析可以利用这些特征来识别文件类型。"
    },
    {
        "question": "不能用来进行数据恢复的工具软件（B）。",
        "options": [
            "A.Encase",
            "B.ExifShow",
            "C.EasyRecovery",
    ...
    {
        "question": "按照检验过程，电子物证检验的四个阶段是（C）。",
        "options": [
        ...
        "answer": "C",
        "hint": "电子物证检验通常包括提取数据—检验数据—分析数据并得出结果—形成鉴定文书这四个阶段。"
    },
    {
    ...
    {
        "question": "在进行电子物证检验时，如果嫌疑人将多个JPEG图片的扩展名改为了其他名称，需要通过（B）方法才能找到这些文件。",
        "options": [
            "A.散列值比对",
            "B.文件签名分析",
            "C.关键字搜索",
    ...
    {
        "question": "“姓名”列被定义为varchar(8)，以下说法正确的是（D）。",
        "options": [
    ...
    },
    {
        ...
        "answer": "C",
        "hint": "在数据库中，将字段清空赋予NULL值。"
    },
    {
        "question": "下列用于定义字段的SQL语句中，错误的是（B）。",
        "options": [
            "A.学号 varchar(10)",
            "B.成绩 int 4",
            "C.产量 float",
    ...
    },
    {
        ...
        "answer": "D",
        "hint": "屏幕锁密钥文件通常存放在/data/system目录下，与特定应用程序相关联。"
    },
    {
        "question": "在现场不关闭电子设备的情况下直接分析和提取电子系统中的数据属于（D）。",
        "options": [
            "A.收集证据",
            "B.提取固定易丢失数据",
            "C.电子证据检查",
        ...
        "answer": "D",
        "hint": "在现场不关闭电子设备的情况下直接分析和提取电子系统中的数据属于在线分析。"
    },
    {
        "question": "易丢失数据提取和在线分析，不得将生成、提取的数据存储在原始存储介质中；无特殊原因需要，不得在目标系统中安装新的应用程序。安装新的应用程序的，应当在（A）中记录安装的程序及目的。",
        "options": [
    ...
    {
        "question": "计算机硬盘为标准的MBR硬盘分区结构，C盘为FAT32文件系统，其DBR备份在第几个扇区上（A）。",
        "options": [
            "A.63扇区",
            "B.32扇区",
            "C.69扇区",
        ...
        "answer": "A",
        "hint": "在FAT32文件系统中，DBR备份通常位于数据区域的开始位置，即63扇区。"
    },
    {
        "question": "ECS服务器指的是以下哪种服务器类型（D）。",
        "options": [
    ...
    {
        "question": "目前手机取证中，需要利用高通（C）端口直接回读userdata分区进行数据提取。",
        "options": [
            "A.8080",
            "B.9006",
            "C.9008",
        ...
        "answer": "C",
        "hint": "高通的9008端口用于直接读取手机的userdata分区，这是一种常见的手机取证技术。"
    },
    {
    ...
    {
        "question": "IMEI是国际移动设备身份码的缩写，国际移动装备识别码，是由（B）位数字组成的“电子串码”，它与每台手机相对应，理论上该码是全世界唯一的。",
        "options": [
            "A.14位",
            "B.15位",
            "C.16位",
        ...
        "answer": "B",
        "hint": "IMEI由15位数字组成，用于唯一标识移动设备。"
    },
    {
        "question": "通常情况下，收集数据的获取由现场环境和取证条件而决定，不包括以下哪种情况？（A）。",
        "options": [
            "A.可视化获取",
            "B.逻辑获取",
            "C.物理获取",
    ...
    {
        "question": "文件ABC.Bmp存放在F盘的T文件夹中的G子文件夹下，它的完整文件标识符是（C）。",
        "options": [
            "A.F:\\T\\G\\ABC",
            "B.T:\\ABC.Bmp",
            "C.F:\\T\\G\\ABC.Bmp",
    ...
    },
    {
        ...
        {
            "question": "352、图片被删除，Thumbs.db中将不可能保存着该图片的缩略图。（×）",
            "options": ["正确","错误"
                
            ],
            "answer": "B",
            "hint": "Thumbs.db是Windows系统中的缩略图缓存文件，如果图片被删除前已经生成了缩略图，该缩略图可能仍会保存在Thumbs.db中。"
        },
        {
...
{
"question": "400、 公安机关、国家安全机关因依法维护国家安全或者侦查犯罪的需要调取数据，可以没有批准手续，个人应当予以配合。(×)",
"options": [
    "正确",
    "错误"
],
"answer": "B",
"hint": "公安机关、国家安全机关因国家安全或侦查需要调取数据时，需要有批准手续，个人应依法配合。"
},
{
"question": "250、 我背完所有的题了，我变强了，我觉得我又行了呢，等级直接满级了呢。(×)",
"options": [
    "正确",
    "错误"
],
"answer": "B",
"hint": "强个屁啦，再给老子练三遍去，这个周末就考试了，做梦呢。"
}
];
